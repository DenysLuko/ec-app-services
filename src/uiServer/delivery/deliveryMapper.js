...
export const mapDelivery = (deliveryResponse) => {
  ...
  return {
    ...
    weightKg: deliveryWeightKg,
    widthCm: deliveryWidthCm,
    heightCm: deliveryHeightCm,
    depthCm: deliveryDepthCm,
    currency: deliveryCurrency,
    value: deliveryValue,
    deliveryStatus,
    deliveryRating,
    deliveryComment,
    senderRating: deliverySenderRating,
    senderComment: deliverySenderComment,
    cancelledComment: deliveryCancelledComment,
    journey,
    sender,
    receiver
  }
