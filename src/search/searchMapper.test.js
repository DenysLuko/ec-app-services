import {
  mapSearch,
  __RewireAPI__ as mapSearchRewireAPI
} from './searchMapper'
...
describe('mapSearch', () => {
  it('should return the resultCount', () => {
    expect(mapSearch(mockResponse)).toHaveProperty('resultCount', 3)
  })

  it('should return the offset', () => {
    expect(mapSearch(mockResponse, 0)).toHaveProperty('offset', 0)
  })
  ...
  describe('results', () => {
    ...
    describe('travellingUser', () => {
      ...
      beforeEach(() => {
        ...
        mapSearchRewireAPI.__Rewire__('mapUser', mockMapUser)
        mapSearch(mockResponse, 0)
      })
      ...
      it('should call mapUser with the first user', () => {
        expect(mockMapUser).toHaveBeenCalledWith({
          ...
          birthday: mockResponse.rows[0].travelling_user_birthday,
          age: null,
          photo: 'somefile.jpg',
        })
      })
      ...
      it('should call mapUser with the second user', () => {
        expect(mockMapUser).toHaveBeenCalledWith({
          ...
          username: 'denyslu',
          email: 'denys.luko@gmail.com',
          birthday: mockResponse.rows[1].travelling_user_birthday,
          age: null,
          photo: 'somefile.jpg',
        })
      })
      ...
      it('should call mapUser with the third user', () => {
        expect(mockMapUser).toHaveBeenCalledWith({
          ...
          birthday: mockResponse.rows[2].travelling_user_birthday,
          age: null,
          photo: 'yerke.jpg',
        })
      })
    ...
    describe('journeyDate formatting', () => {
      ...
      it('should return the date object if no format is passed', () => {
        expect(firstResult.journeyDate({})).toEqual(mockResponse.rows[0].journey_date)
      })
    })
